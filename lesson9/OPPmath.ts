class Shape {
    ...
    // Returns the current position as an object {x, y}
    public get position(): {x: number, y: number} {
        return {x: this.#x, y: this.#y }
    }

    // Sets the position, validating that both coordinates are non-negative
    ...
    // Sets the color, validating that it is not empty or just whitespace
